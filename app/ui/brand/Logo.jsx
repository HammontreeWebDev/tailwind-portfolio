/**
 * Hammontree Full-Stack Solutions — SVG logo system
 * Full lockup SVG: /public/brand/hammontree-logo-full.svg (for business cards & print)
 * Standalone mark: /public/brand/hammontree-logo-mark.svg (favicon, app icons, social avatars)
 */
...
function FullLockupSvg({ className = "" }) {
  return (
    ...
    >
      ...
      <text x="44" y="22" fontFamily="var(--font-display), system-ui, sans-serif" fontSize="18" fontWeight="700" letterSpacing="-0.02em" fill="#F4F7F8">
        Hammontree
      </text>
      <text x="44" y="38" fontFamily="var(--font-body), system-ui, sans-serif" fontSize="9" fontWeight="600" letterSpacing="0.18em" fill="#30B8BF">
